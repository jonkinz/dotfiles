        ...
        jdtls = function(_, opts)
          vim.api.nvim_create_autocmd("FileType", {
            ...
            callback = function()
              ...
              local workspace_dir = "/home/jonathan/.workspace/" .. project_name -- See `:help vim.lsp.start_client` for an overview of the supported `config` options.
              local config = {
                ...
                cmd = {
                  ...
                  --"-javaagent:/home/jonathan/.local/share/java/lombok.jar",
                  -- '-Xbootclasspath/a:/home/jonathan/.local/share/java/lombok.jar',
